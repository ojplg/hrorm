 ...
 */
public class GenericKeyDaoBuilder<ENTITY, BUILDER, PK>  implements SchemaDescriptor<PK, ENTITY, BUILDER> {
     ...
     */
    public GenericKeyDaoBuilder<ENTITY, BUILDER, PK> withStringColumn(String columnName, Function<ENTITY, String> getter, BiConsumer<BUILDER, String> setter){
     ...
     * @return This instance.
     */
    public GenericKeyDaoBuilder<ENTITY, BUILDER, PK> withLongColumn(String columnName, Function<ENTITY, Long> getter, BiConsumer<BUILDER, Long> setter){
     ...
     * @return This instance.
     */
    public GenericKeyDaoBuilder<ENTITY, BUILDER, PK> withBigDecimalColumn(String columnName, Function<ENTITY, BigDecimal> getter, BiConsumer<BUILDER, BigDecimal> setter){
     ...
     * @return This instance.
     */
    public <E> GenericKeyDaoBuilder<ENTITY, BUILDER, PK> withConvertingStringColumn(String columnName, Function<ENTITY, E> getter, BiConsumer<BUILDER, E> setter, Converter<E, String> converter){
     ...
     * @return This instance.
     */
    public GenericKeyDaoBuilder<ENTITY, BUILDER, PK> withInstantColumn(String columnName, Function<ENTITY, Instant> getter, BiConsumer<BUILDER, Instant> setter){
     ...
     * @return This instance.
     */
    public GenericKeyDaoBuilder<ENTITY, BUILDER, PK> withBooleanColumn(String columnName, Function<ENTITY, Boolean> getter, BiConsumer<BUILDER, Boolean> setter){
     ...
     * @return This instance.
     */
    public GenericKeyDaoBuilder<ENTITY, BUILDER, PK> withStringBooleanColumn(String columnName, Function<ENTITY, Boolean> getter, BiConsumer<BUILDER, Boolean> setter){
     ...
     * @return This instance.
     */
    public GenericKeyDaoBuilder<ENTITY, BUILDER, PK> withIntegerBooleanColumn(String columnName, Function<ENTITY, Boolean> getter, BiConsumer<BUILDER, Boolean> setter){
    ...
    public GenericKeyDaoBuilder<ENTITY,BUILDER, PK> withPrimaryKey(String columnName, GenericColumn<PK> genericColumn,
                                                                   Function<ENTITY, PK> getter, BiConsumer<BUILDER, PK> setter){
        PrimaryKey<PK, ENTITY, BUILDER> primaryKey = new GenerativePrimaryKey<>(
                primaryKeyGenerator,
                genericColumn,
                daoBuilderHelper.getPrefix(),
                columnName,
                getter,
                setter);
     ...
     * @return This instance.
     */
    public <P> GenericKeyDaoBuilder<ENTITY, BUILDER, PK> withParentColumn(String columnName, Function<ENTITY,P> getter, BiConsumer<BUILDER,P> setter){
     ...
     * @return This instance.
     */
    public GenericKeyDaoBuilder<ENTITY, BUILDER, PK> withParentColumn(String columnName) {
     ...
     * @return This instance.
     */
    public GenericKeyDaoBuilder<ENTITY, BUILDER, PK> notNull(){
     ...
     * @return This instance.
     */
    public GenericKeyDaoBuilder<ENTITY, BUILDER, PK> setSqlTypeName(String sqlTypeName){
     ...
     * @return This instance.
     */
    public <T> GenericKeyDaoBuilder<ENTITY, BUILDER, PK> withGenericColumn(String columnName,
     ...
     * @return This instance.
     */
    public <T,U> GenericKeyDaoBuilder<ENTITY, BUILDER, PK> withConvertedGenericColumn(String columnName,
     ...
     * @return This instance.
     */
    public GenericKeyDaoBuilder<ENTITY, BUILDER, PK> withUniqueConstraint(String ... columnNames){
