...
public class DataColumnFactory {
    ...
    public static <ENTITY, BUILDER> Column<ENTITY, BUILDER> instantColumn(
        ...
        return new ConvertingColumnImpl<>(GenericColumn.TIMESTAMP, prefix, name, getter, setter, GenericColumn.TIMESTAMP.getSqlTypeName(), nullable, Converters.INSTANT_TIMESTAMP_CONVERTER);
    }
    ...
    public static <TYPE, ENTITY, BUILDER> Column<ENTITY, BUILDER> stringConverterColumn(
        ...
        return new ConvertingColumnImpl<>(GenericColumn.STRING, prefix, name, getter, setter, GenericColumn.STRING.getSqlTypeName(), nullable, converter);
    }
