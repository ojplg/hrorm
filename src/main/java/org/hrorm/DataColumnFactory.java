...
public class DataColumnFactory {
    ...
    public static <ENTITY, BUILDER> Column<BigDecimal, ENTITY, BUILDER> bigDecimalColumn(
    ...
    public static <ENTITY, BUILDER> Column<Long, ENTITY, BUILDER> longColumn(
    ...
    public static <ENTITY, BUILDER> Column<Boolean, ENTITY, BUILDER> booleanColumn(
    ...
    public static <ENTITY, BUILDER> Column<String, ENTITY, BUILDER> textBackedBooleanColumn(
            String name, String prefix, Function<ENTITY, Boolean> getter, BiConsumer<BUILDER, Boolean> setter, boolean nullable) {
    ...
    public static <ENTITY, BUILDER> Column<Long, ENTITY, BUILDER> longBackedBooleanColumn(
            String name, String prefix, Function<ENTITY, Boolean> getter, BiConsumer<BUILDER, Boolean> setter, boolean nullable) {
    ...
    public static <ENTITY, BUILDER> Column<String, ENTITY, BUILDER> stringColumn(
    ...
    public static <ENTITY, BUILDER> Column<Timestamp, ENTITY, BUILDER> instantColumn(
    ...
    public static <TYPE, ENTITY, BUILDER> Column<String, ENTITY, BUILDER> stringConverterColumn(
    ...
    public static <TYPE, ENTITY, BUILDER> Column<TYPE, ENTITY, BUILDER> genericColumn(
            String name, String prefix, Function<ENTITY, TYPE> getter, BiConsumer<BUILDER, TYPE> setter,
    ...
    public static <TYPE, DBTYPE, ENTITY, BUILDER> Column<DBTYPE, ENTITY, BUILDER> convertedGenericColumn(
            String name, String prefix, Function<ENTITY, TYPE> getter, BiConsumer<BUILDER, TYPE> setter,
